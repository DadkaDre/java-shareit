...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    List<Booking> getALLByItemIdAndBookerIdAndStatusEqualsOrderByEndDesc(Long itemId, Long userId, Status status);
    ...
    void findTopByItemIdAndEndBeforeAndStatusInOrderByEndDesc(int i, LocalDateTime now, List<Status> approved);

    void findTopByItemIdAndStartAfterAndStatusInOrderByStartAsc(int i, LocalDateTime now, List<Status> approved);

    Object findAllByBookerIdAndItemIdAndStatusEqualsAndEndIsBefore(int i, int i1, Status any, LocalDateTime any1);
}
