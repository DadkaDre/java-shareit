...
public class ItemServiceImpl implements ItemService {
    ...
    public void delete(Long itemId) {
        Item item = itemRepository.findById(itemId).orElseThrow(() -> new NotFoundException("Вещи с id = {} нет." + itemId));
    ...
    public CommentInfoDto addComments(Long userId, CommentDto commentDto, Long itemId) {
        ...
        List<Booking> bookings = bookingRepository.getALLByItemIdAndBookerIdAndStatusEqualsOrderByEndDesc(itemId, userId, Status.APPROVED);
        if (bookings == null) {
